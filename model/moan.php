...
{
    $sql = "UPDATE tbl_monan SET is_deleted = 1 WHERE id_monan = ?";
    pdo_execute($sql, $id);
}

function list_monan_All()
{
    $sql = "SELECT * FROM tbl_monan, tbl_danhmuc WHERE tbl_monan.id_danhmuc = tbl_danhmuc.id_danhmuc AND tbl_monan.is_deleted = 0 ORDER BY id_monan DESC";
...
{
    $sql = "SELECT * FROM tbl_monan WHERE id_monan = ? AND is_deleted = 0";
...
{
    if ($new_anhmonan != "") {
        $sql = "UPDATE tbl_monan SET ten_monan = ?, gia_monan = ?, anh_monan = ?, id_danhmuc = ?, mota_monan = ?, noibat = ? WHERE id_monan = ? AND is_deleted = 0";
        pdo_execute($sql, $ten_monan, $gia_monan, $new_anhmonan, $id_danhmuc, $mota_monan, $noibat, $id_sua);
    } else {
        $sql = "UPDATE tbl_monan SET ten_monan = ?, gia_monan = ?, id_danhmuc = ?, mota_monan = ?, noibat = ? WHERE id_monan = ? AND is_deleted = 0";
