...
function submitmail()
{
  ...
  $tieude = "Đặt hàng website Fusion Food thành công !";
  $noidung = "";
        ...
        <div style="margin:0 auto;max-width:600px;">
            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tr style="vertical-align:top;">
                    <td background="https://images.unsplash.com/photo-1573376670774-4427757f7963?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=80"
                        style="background:#2a3448 url() no-repeat center center / cover;background-position:center center;background-repeat:no-repeat;padding:0px;vertical-align:top;"
                        height="">
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div
                                                                    style="font-family:Muli, Arial, sans-serif;font-size:20px;font-weight:400;line-height:30px;text-align:center;color:#333333;">
                                                                    <h1
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Cảm ơn bạn đã đặt hàng của
                                                                        chúng tôi. Vui lòng xem chi tiết đơn hàng
                                                                        bên dưới:
                                                                    </p>
                                                                </div>
                                                            </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <div
                                                                    style="font-family:Muli, Arial, sans-serif;font-size:16px;font-weight:400;line-height:20px;text-align:left;color:#333333;">
                                                                    <p style="margin: 0;"> Nếu bạn có bất kỳ câu hỏi nào
                                                                        hoặc cần thêm thông tin về việc
                                                                        trả lại hàng <a href="#"
                                                                            style="color: #AC7B4C; text-decoration: none;">xem
                                                                            chính
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                ...
                                                © 2024, Hà Nội, VIETNAM, CA 12221</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                            ...
                                            <div
                                                style="font-family:Muli, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:center;color:#616161;">
                                                Cập nhật <a href="https://google.com"
                                                    style="color: #AC7B4C; text-decoration: none;">email
                                                    của bạn</a>để chọn loại email bạn nhận được hoặc bạn có thể <a
                                                    href="https://google.com"
                                                    style="color: #AC7B4C; text-decoration: none;">hủy đăng ký </a>từ
                                                tất cả các email trong tương
                                                lai.</div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <tbody>
                              <tr>
                                <td style="width:550px;">
                                  <img alt="welcome image" height="auto" src="https://nld.mediacdn.vn/291774122806476800/2023/4/13/pass-16813720277072117425861.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="550">
                                </td>
                              </tr>
                            </tbody>
                          </table>
                          ...
                          <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                      <h1 style="margin: 0; font-size: 32px; line-height: 40px;">Chào bạn!<br>Bạn đã quên mật khẩu đừng lo? </h1>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Alata;font-size:14px;font-weight:400;line-height:24px;text-align:left;color:#333333;">Bạn có câu hỏi hoặc cần giúp đỡ? Gửi email cho chúng tôi tại <a href="#" style="color: #ea4a40; text-decoration: none;"> info@fusionfood.com </a></div>
                                  </td>
                                </tr>
                              </table>
                            </div>
