                ...
                <div class="main-bar clearfix ">
                    <div class="container clearfix">
                        ...
                        <div class="logo-header mostion">
                            <a href="index.php" class="anim-logo"><img class="mu" style="background-color: #fff;" src="views/assets/images/logo_home.png" alt="/"></a>
                            <a href="index.php" class="anim-logo-white"><img src="views/assets/images/logo_act.png" alt="/"></a>
                        </div>
                        ...
                        <div class="offcanvas-form">
                            <div class="row g-0">
                                <div class="col-md-4 gradient-custom text-center text-white">
                                    <img src="" alt="Avatar" class="img-fluid my-2 mt-4" />
                                    <h5>
