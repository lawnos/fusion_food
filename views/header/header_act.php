                ...
                <div class="main-bar clearfix ">
                    <div class="container clearfix">
                        ...
                        <div class="logo-header mostion">
                            <a href="index.php" class="anim-logo"><img class="mu" style="background-color: #fff;"
                                    src="views/assets/images/logo_home.png" alt="/"></a>
                            <a href="index.php" class="anim-logo-white"><img src="views/assets/images/logo_act.png"
                                    alt="/"></a>
                        </div>
                        ...
                        <div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                            <div class="logo-header">
                                <a href="index.php" class="anim-logo"><img src="views/assets/images/logo.png"
                                        alt="/"></a>
                            </div>
                                    ...
                                    <ul class="mega-menu">
                                        <li><a href="javascript:;">Trang</a>
                                            <ul>
                                                ...
                                                <li><a href="index.php?act=danggia">Đánh giá</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="javascript:;">Trang</a>
                                            <ul>
                                                ...
                                                <li><a href="index.php?act=trangloi">Trang lỗi</a></li>
                            ...
                            <div class="col-md-8">
                                <div class="card-body p-4">
                                    ...
                                    <div class="row pt-1">
                                        ...
                                        <div class="col-12 mb-3">
                                            <h6><a
                                                    href="index.php?act=theodoidonhang&id_nguoidung=<?= $id_nguoidung ?>">Theo
                                                    dõi đơn hàng </a>
                                            </h6>
                                        </div>
                                        <div class="col-12 mb-3">
                    ...
                    <div class="offcanvas-form">
                        ...
                        <p class="text-center m-t30">Chưa có tài khoản?
                            <a class="register text-primary font-weight-500" data-bs-toggle="offcanvas"
                                href="#offcanvasRegister" role="button" aria-controls="offcanvasRegister">Đăng ký ở
                                đây</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="offcanvas-form">
                        ...
                        <div class="form-group m-b15">
                            ...
                            <div class="input-group">
                                <input name="hoten" type="text" class="form-control check_name"
                        ...
                        <div class="form-group m-b15">
                            <label class="form-label">Số điện thoại*</label>
                            <div class="input-group">
                                <input name="sodienthoai" type="text" class="form-control check_sdt"
                        ...
                        <div class="form-group m-b15">
                            ...
                            <div class="input-group">
                                <input name="email" type="text" class="form-control check_email"
                        ...
                        <div class="form-group m-b30">
                            <label class="form-label">Mật khẩu*</label>
                            <div class="input-group search-input">
                                <input name="pass" type="password" class="form-control dz-password check_pass"
                        ...
                        <button name="submit" value="submit" type="submit" id="btn_dangki"
        ...
        btn_dangki.addEventListener("click", function(e) {
            ...
            if (check_pass.value.trim() === "") {
                ...
                if (!passwordRegex.test(check_pass.value)) {
                    err_pass.innerHTML =
                        "Mật khẩu phải có ít nhất 8 ký tự, bao gồm chữ cái viết thường, chữ cái viết hoa, số và ký tự đặc biệt";
                }
            }
