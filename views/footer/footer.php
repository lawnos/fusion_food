                    ...
                    <div class="widget widget_getintuch">
                        ...
                        <ul>
                            <li>
                                ...
                                <p>80 Xuân Phương, P. Phương Canh, Q. Nam Từ Liêm, tp.Hà Nội</p>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <p>anhsonw24@gmail.com<br>
                                    info@fusionfood.com</p>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="footer-bottom">
            <div class="row">
                <div class="col-xl-6 col-md-6 text-md-start">
                    <p>Bản quyền của công ty Fusion Food@</p>
                </div>
...
<script src="views/assets/vendor/bootstrap-select/js/bootstrap-select.min.js"></script>
<script src="views/assets/vendor/magnific-popup/magnific-popup.js"></script>
<script src="views/assets/vendor/counter/waypoints-min.js"></script>
<script src="views/assets/vendor/wow/wow.js"></script>
<script src="views/assets/vendor/counter/counterup.min.js"></script>
<script src="views/assets/vendor/swiper/swiper-bundle.min.js"></script>
<script src="views/assets/vendor/popper/popper.js"></script>
<script src="views/assets/vendor/tempus-dominus/js/tempus-dominus.min.js"></script>
<script src="views/assets/vendor/tilt/tilt.jquery.min.js"></script>
<script src="views/assets/js/dz.carousel.min.js"></script>
<script src="views/assets/js/dz.ajax.js"></script>
