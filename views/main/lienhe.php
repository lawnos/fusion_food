            ...
            <form action="index.php?act=lienhechungtoi" method="POST">
                <div class="row">
                    ...
                    <div class="col-sm-12 m-b40">
                        ...
                        <div class="input-group input-line input-black">
                            <textarea name="noidung" class="form-control"
                                placeholder="Xin chào, hãy nêu ý kiến của bạn!"><?php
                    ...
                    <div class="col-12 text-center">
                        <button name="submit" value="submit" type="submit" class="btn btn-primary btn-hover-1"><span>Gửi
                                lời nhắn</span></button>
                    </div>
                </div>
            </form>
        </div>
