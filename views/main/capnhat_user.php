                                    ...
                                    <div class="offcanvas-form">
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="hoten" value="<?= $hoten ?>" required type="text" class="form-control" placeholder="Nhập họ và tên">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="anh_taikhoan" value="<?= $anh_taikhoan ?>" type="file" class="form-control" placeholder="Nhập họ và tên">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-b15">
                                            ...
                                            <div class="input-group">
                                                <input name="sodienthoai" value="<?= $sodienthoai ?>" required type="text" class="form-control" placeholder="Nhập số điện thoại">
                                            </div>
                                        </div>
                                        <div class="form-group m-b15">
                                            <label class="form-label">Email*</label>
                                            <div class="input-group">
                                                <input name="email" value="<?= $email ?>" required type="text" class="form-control" placeholder="Nhập email">
                                            </div>
                                        </div>
                                        <div class="form-group m-b15">
                                            <label class="form-label">Địa chỉ*</label>
                                            <div class="input-group">
                                                <input name="diachi" value="<?= $diachi ?>" required type="text" class="form-control" placeholder="Nhập địa chỉ">
                                            </div>
                                        </div>
                                        <div class="form-group m-b30">
                                            <label class="form-label">Mật khẩu*</label>
                                            <div class="input-group search-input">
                                                <input name="pass" value="<?= strtolower($matkhau) ?>" type="password" class="form-control dz-password" placeholder="Nhập mật khẩu mới">
                                                <div class="show-pass">
